...
list_list1 = [('a',1),('a',5),('b',10),('b',15),('c',-10),('c',0),('c',12)]
list_list2 = [('a',1),('b',10),('c',-10),('d',10),('e',1)]
...
print ("count lists ", count_list_list1, count_list_list2,"\n")
print ("count by key lists", countByKey_list_list1, countByKey_list_list2, "\n")
print ("count by value lists", countByValue_list_list1, countByValue_list_list2, "\n")
print ("collet as Map lists",collectAsMap_list_list1, collectAsMap_list_list2, "\n")